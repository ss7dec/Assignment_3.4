...
//2. Create a method result which accepts marks in three subjects along with the student roll 
//   number and return the result of that student as pass or fails.

//3. Create another class StudentResultProcesing and extend this class from the student class
...
package assignment_3_4; //This java file is inside package named src folder.
...
public class Student {
	//Declaring class for student details.
